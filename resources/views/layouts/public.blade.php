...
<nav class="navbar navbar-toggleable-md navbar-inverse navbar-expand-lg navbar-light bg-light fixed-top bg-inverse">
    ...
    <div class="collapse navbar-collapse " id="navbarsExampleDefault">
        ...
        <form class="form-inline mt-2 mt-md-0">
            <input class="form-control mr-sm-2" id="search" type="text" placeholder="Поиск статей">
            <ul id="ui-id-2" class="search_ul" tabindex="0">
            </ul>
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column">
                ...
                <li class="block_time_fixed">
                    @include('inc.block_time')
                </li>
            </ul>
        </nav>
        @yield('content')
